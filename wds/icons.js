// WDS icon shim — SVG icons used in aria-home-flow
(function () {
  const ICONS = {
    ...
    sparkle:      '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.4 7.6H22l-6.4 4.6 2.4 7.6L12 17.2l-6 4.6 2.4-7.6L2 9.6h7.6z"/></svg>',
  ...
  window.WdsIcon = function (name, opts) {
